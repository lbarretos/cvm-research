...
As Camadas 1, 2 e 3 rodam no job semanal logo após `ingest_dfp`/`ingest_itr` (base inteira, ~1,5 min).
...
python run_all.py --layer 1,2,3 --cnpj 84.429.695/0001-11 # todas as camadas
